                ...
                <div className="flex flex-col space-y-5 items-baseline w-[50%]">
                    ...
                    <div className="flex flex-col space-y-4">
                        ...
                        <div className="flex items-center space-x-3">
                            ...
                            <img src={IconRating} alt="rating" className="w-8 h-8"/>
                            <img src={IconRating} alt="rating" className="w-8 h-8"/>
                            <img src={IconRatingHaft} alt="ratingHaft" className="w-8 h-8"/>               
                        </div>
                        <p className="text-white">Lorem ipsum dolor sit amet consectetur adipisicing elit. Possimus voluptatum qui quibusdam porro corrupti reprehenderit. Laborum, dolorum quo tenetur, nemo dignissimos est veniam saepe quos culpa, similique at iste maiores?</p>
